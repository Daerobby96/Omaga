{{-- resources/views/admin/prodi/create.blade.php --}}
@extends('layouts.app')
@section('title','Tambah Program Studi')
@section('page-title','Tambah Program Studi Baru')
@section('page-sub','Formulir tambah program studi')
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kode_prodi" class="form-control @error('kode_prodi') is-invalid @enderror" value="{{ old('kode_prodi') }}" placeholder="TI">
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-6">
                    ...
                    <input type="text" name="fakultas" class="form-control" value="{{ old('fakultas') }}" placeholder="Contoh: Teknik">
                </div>
                <div class="col-md-6">
                    ...
                    <select name="jenjang" class="form-select @error('jenjang') is-invalid @enderror">
                        ...
                        <option value="S1" {{ old('jenjang') == 'S1' ? 'selected' : '' }}>S1 - Strata 1</option>
            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="tahun_akreditasi" class="form-control" value="{{ old('tahun_akreditasi') }}" min="2000" max="{{ date('Y') }}">
                </div>
            </div>
            <div class="row g-3 mt-2">
                <div class="col-md-12">
