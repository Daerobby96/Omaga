{{-- resources/views/mahasiswa/pengajuan/create.blade.php --}}
@extends('layouts.app')
...
<form action="{{ route('mahasiswa.pengajuan.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card mb-4">
        <div class="card-header"><span class="card-header-title"><i class="fas fa-file-alt me-2 text-warning"></i>Dokumen</span></div>
        <div class="card-body">
            <div class="alert alert-info mb-3">
                <i class="fas fa-info-circle me-2"></i>
                <strong>Surat Pengantar</strong> akan dibuat secara otomatis oleh sistem setelah pengajuan disetujui oleh Prodi.
            </div>
            <div class="row g-3">
                <div class="col-md-6">
